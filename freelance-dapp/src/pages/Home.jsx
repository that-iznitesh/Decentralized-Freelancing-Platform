...
//             className="px-6 py-3 rounded-xl bg-gradient-to-r from-green-400 to-emerald-500 hover:scale-105 transition duration-300 shadow-lg"
//           >
//             🚀 Find Work
//           </button>
...
//             className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 hover:scale-105 transition duration-300 shadow-lg"
//           >
//             💼 Hire Talent
//           </button>
